...
namespace IT_lab5.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //POST Action View for Verify2FA view////////////////////
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if(user.Email.Contains("@finki.ukim.mk"))
                        await UserManager.AddToRoleAsync(user.Id, "Professor");
                    else if(user.Email.Contains("@students.finki.ukim.mk")) 
        ...
        public ActionResult AssignRole()
        {
            ...
            role.AllRoles = new List<string>() { "Professor", "Student"};
